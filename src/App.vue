...
<template>
  <main
    class="w-screen min-h-screen p-6 font-mono transition-colors duration-200"
  ...
  >
    ...
    <div class="fixed top-4 right-4 z-10">
      <div class="relative">
        ...
        <div
          v-if="themeMenuOpen"
          class="absolute right-0 mt-1 border"
          :style="{
            borderColor: theme.surface1,
            backgroundColor: theme.surface0,
          }"
    ...
    <div class="flex flex-wrap gap-4">
      ...
      <div
        ...
        :key="group.id"
        class="flex-1 min-w-[calc(25%-12px)] max-w-full border p-4 transition-colors"
        :style="{
      ...
      <div
        ...
        :style="{ borderColor: theme.surface1, color: theme.overlay0 }"
